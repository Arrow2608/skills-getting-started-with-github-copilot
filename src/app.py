...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and aquatic fitness for all levels",
    ...
    "Drama Club": {
        "description": "Create and perform plays, improv exercises, and stagecraft",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore STEM topics with hands-on projects",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
